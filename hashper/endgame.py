...
for x,y in zip(trainingdata, trainingdataLabels):
    ...
    try:
        ...
        probs2val = 0
    #laplace smoothing
    player = float((probs0val + 1))/float(probs0val + probs1val + probs2val + 3)
    banker = float((probs1val + 1))/float(probs0val + probs1val + probs2val + 3)
    tie = float((probs2val + 1))/float(probs0val + probs1val + probs2val + 3)
